...
async function main() {
  ...
  const p1 = await prisma.product.create({
    data: {
      ...
      imageUrl: "/uploads/pressure_washer.png",
      brand: "Karcher",
      rentalUnit: "day",
      price: 75,
      securityDeposit: 200,
  ...
  const p2 = await prisma.product.create({
    data: {
      ...
      imageUrl: "/uploads/excavator.png",
      brand: "Caterpillar",
      rentalUnit: "day",
      price: 350,
  ...
  const p3 = await prisma.product.create({
    data: {
      ...
      imageUrl: "/uploads/formal_shirt.png",
      brand: "Zara",
      rentalUnit: "day",
      price: 15,
      securityDeposit: 30,
  ...
  const p4 = await prisma.product.create({
    data: {
      ...
      category: "Clothing",
      image: "/uploads/cotton_tee.png",
      imageUrl: "/uploads/cotton_tee.png",
      brand: "Levis",
      rentalUnit: "day",
      price: 10,
      securityDeposit: 15,
  ...
  const p5 = await prisma.product.create({
    data: {
      ...
      imageUrl: "/uploads/running_shoes.png",
      brand: "Nike",
      rentalUnit: "day",
      price: 25,
      securityDeposit: 50,
